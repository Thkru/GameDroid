...
public class OldGame implements Parcelable {
    ...
    public OldGame(int id, String name, String releaseDate, String text, String developer) {
        this.id = id;
        this.name = name;
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        public OldGame createFromParcel(Parcel in) {
            return new OldGame(in);
        }
        public OldGame[] newArray(int size) {
            return new OldGame[size];
        }
    };
